...
I do think the differences between expected and observed frequencies are meaningful, despite the numbers being nearly identical in the respective categroies for 'B', 'D' and even pretty similar for 'F'. But for 'A' and 'C' there's a difference of 20 from the expected to observed frequency. To me this is enough to consider meaningful, as much more students are getting A's than expected.
...
We do reject the null hypothesis since the chi-square statistic is greater than the critical value. This means that the observed grade frequencies are significantly different from the expected grade frequencies, proving that the grades are very different from what was expected. When I first saw the values I did think there was a real difference and this corroborates that view.
...
Like I said earlier, the major differences are clearly in the 'A' and 'C' categories, as there are 20 more in the 'A' in the observed compared to the expected, and vice versa for 'C'. This is particularly notable as it shows students are doing better than expected. I would ask colleges/instructors why they think this is — what specific teaching methods are working? Additionally, I'd ask instructors about the criteria to receive an 'A' — is there a chance that it's too low and this is the reason for so many students doing so well? 
