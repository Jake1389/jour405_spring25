...
There are numerous categories of incidents given here, including accidents, assaults, robbery's and more. Accidents feel like something relevant to report on, considering how that can truly happen to anyone at any point (without someone neccesarily being to blame). Robbery would definitely be crucial as well, since that can happen and be detrimental. In terms of summarizing the data, accidents certainly make it more difficult due to the high numbers. These forms of accidents, along with automobiles stolen, are the clear leaders in terms of quantity of crimes over the year span. 
...
The highest average number of incidents per month is general accidents. The lowest average number of incidents per month is homicide. This tells me that there is more accidents than provoked and intentional crime. Homicide being so low is definitely a good thing, I'd be interested in finding out what precautions are taken for the stats to be so low. I'd also want to ask about auto incidents, why are stats for theft and stolen autmoboiles so high? What are things that can be done to help mitigate this?
...
Unfortunately I can't give an answer here. I spent over an hour on task six and I just could not get it to run. Happy to talk further and go over things, I just have no idea why it didn't work and hence I can't answer this question. 
...
Among many issues plaguing College Park, accidents stand out as truly detrimental.

There was an average of 481 accidents per month over the past year. That was higher than robberies, homnicide or any other form of crime in College Park. The issue further exacerbated in October, November, and December -- the only three months of the year that saw over 500 accidents. The town may need to take more precautions, or else this problem may continue going in the wrong direction. 
