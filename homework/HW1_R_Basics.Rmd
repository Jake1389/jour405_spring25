...
For the last part about loading the data, I think I have the correct code but it says "'data/students.csv' does not exist in current working directory ('/Users/jake/GitHub/jour405_spring25/homework')." So I'm not positive what to do here, any help would be appreciated!
