...
GDP_data |> 
  ...
  labs(title = "DJIA and GDP Correlation Chart")
```
...
There is an incredibly strong correlation between the two variables — when DJIA increases, the GDP also increases. The scatterplot visually proves this with the clear correlated increase, while the correlation coefficient — which is extremely high at around 95% — further corroborates this correlation. 
