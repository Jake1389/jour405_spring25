...
Private and public colleges have mucher higher mean and median SAT scores, though private reigns at the top. The most notable aspect of these statistics is community colleges, though, which have a mean and median score of around 300 points lower than the next closest college (public). This is a much bigger disparity than the one between private and public, so it particularly stands out. The minimum and maximum scores at community colleges are also much lower than public and private colleges, further proving the point of how community college students generally have lower SAT scores. 
...
There absolutely is, private colleges have the highest SAT scores, but the most notable part is how low community college scores are comparatively to the other two. 
2. Which specific college types differ from each other?
Community college has the biggest difference when pitted against private colleges, though it also is much lower than public colleges SAT scores.
3. How large are these differences?
Private colleges have SAT scores that are 366.96 points higher than community colleges on average, while public colleges have SAT scores that are 292.55 points higher than community colleges on average.

Headline:
Data shows Maryland community college students are struggling on SAT tests 

Paragraph:

Data taken of SAT scores in Maryland showed that community college students had a mean SAT score of around 1070 and had significantly lower minimum and maximum scores than public and private college students. Private school college students had a mean of about 1435 on their SAT, with public school college students coming in almost 100 points lower — the major disparity is among community college students.
