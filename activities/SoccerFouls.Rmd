...
There is virtually no correlation here between the goal differential and the fouls, which corroborates the low correlation number in task 4. If the correlation number was higher, it's likely we would be able to tell that here through the scatterplot. This shows how a scatterplot and correlation number can work in sync to tell a story (in this case about the lack of correlation between goal differential and fouls).
