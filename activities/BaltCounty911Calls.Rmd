...
It seems like the amount of daily calls is pretty high throughout the summer months, there seems to be some outliers around that time. Though even in October, there is the highest total of daily calls on a day. At the start of the year, the daily call total seems especially low, with a few extremely low figures. The winter as a whole seems to generally be lower. The lines I'd draw would probably be around 17 for above and about 5 for below — they seem like good benchmarks for when things are true outliers and worth looking into heavily.  
...
So I seemed to be relatively right on that the months around the summer had high call totals, most of the red dots are around the summer months. The unusually low scores were pretty sporadic, with one of the lowest totals even falling near June. I will say it seems that the winter months had lower totals, coinciding sort of with what I said before about calls being lower around the new year. Overall, it seemed like my prior answer was decent, but that the call totals were more sporadic throughout the year than I realized. It would be interesting to further investigate and find out which months specificially have low/high totals.
...
Tuesday had the highest amount of fluctuations, relative to other days of the week, in terms of total drug overdose calls in Baltimore County. 
...
A potential angle would be how many fewer overdose calls there were during winter months. Also, for whatever reason amid high totals in calls during most of the summer, June sees a dip in overdose calls — it would be fascinating to find out why that is. Totals are also low near the new year, which could be something interesting to investigate further into. My next steps would be doing more research to try and gauge more about these numbers. Reaching out to people with more knowledge — like police, the DEA, etc — would be smart to gain more insight that goes beyond what can be found online. I'd tell my editor about the three things I mentioned which I found interesting — then we could devise a plan as to how to further pursue them and decide which is ultimately the best to pursue.
