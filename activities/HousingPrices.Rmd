...
The new transit line is causing an increase in home values in a local neighborhood. While there could be other reasons for the increase, all indications point to the transit line being the primary motivator behind the uptick. The prior mean of a house's price was $285,000, while the new mean is $304,500 — a nearly $20,000 increase that could be problematic for families.
