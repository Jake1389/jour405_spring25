...
I would reject the null hypothesis since the chi-square statistic is greater than the critical value. This means that the observed frequencies are significantly different from the expected frequencies, proving that the movie ratings are very different from what was expected. 
