...
It is different in some regards, with the most notable contrast being in 5 star ratings, in which there's 15 less in the observed frequency compared to the expected. There were more 4 star ratings in the observed frequency and less 5 and 3 star picks. The amount of 1 star ratings was similar across the expected and observed frequencies, while there were 12 more 2 star ratings than expected.
...
I would reject the null hypothesis since the chi-square statistic is greater than the critical value. This means that the observed frequencies are significantly different from the expected frequencies, proving that the movie ratings are very different from what was expected. When I first saw the values I didn't see much of a difference, this shows why it is important to check things over and use proven techniques (like the chi-square) to find how significant a difference is.
