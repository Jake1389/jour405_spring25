...
0.23 is a lot lower, that means the person is counted less than an average person, while 3.04 is much higher, that means the person is counted much more than an average person.

3. Why might some respondents be weighted more heavily than others?
A person of a subgroup that is less represented may be weighed more as to try and provide a more holistic view of that groups views. The reality is that you can't always get an equal amount of people for respective groups, so to try and keep things balanced certain people have to be weighed more.
...
The rarely/never group shows the biggest difference between weighted and unweighted results.

2. How might these differences affect reporting on likely voter turnout?
These differences are key as they better show who is most unsure on if they're voting. The interesting thing is that these "unsure" voters are more likely to shift their decision then the "always" or "sporadic" group - this is a big part of how Trump won, winning those voters who rarely voted and were less likely to take surveys. This calculated information can help a reporter gauge polls - and the reality of how they're estimates that can be wrong, hence why it's important to look beyond them much of the time. 
...
This tells me that the slightly disinterested people are likely under-represented at times. I think these differences largely exist because these people are harder to reach so a lot of the time they're not accurately accounted for in surveys. This (and the charts we made) futher demonstrate why weighing is important to accurately gauge the views of a group. These "rarely/never" people are still crucial to sample, especially using weighing to better gauge the holistic view of the group. Especially from Trump winning (despite so many polls saying he would not), maybe the "always" and "sporadic" voters have been over-represented at times, and a better balance is needed.
